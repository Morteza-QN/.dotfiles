...
New-Alias ee exit
New-Alias ll Get-ChildItem|Format-Wide
# Functions
New-Alias lanoff 'netsh interface set interface "Ethernet" disable'
New-Alias lanon 'netsh interface set interface "Ethernet" enable'
